...
class TestTools(unittest.TestCase):
    ...
    def test_MI_states_num(self):
        self.assertTrue(len(self.states_pages['MI'])>5, "Testing if there are enough parks in MI")
    def test_AL_states_num(self):
        self.assertEqual(len(self.states_pages['AL'])>5, "Testing if there are enough parks in AL")
    def test_FL_states_num(self):
        self.assertEqual(len(self.states_pages['FL'])>5, "Testing if there are enough parks in FL")
